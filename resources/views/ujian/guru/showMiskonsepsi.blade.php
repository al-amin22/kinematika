    ...
    <div class="row">
        <div class="col-md-12">
            <div class="alert alert-success" role="alert">
                <h5 class="alert-heading mb-0" style="background: #FF7F50;"><strong>{{$miskonsepsi->jenis}} ({{$miskonsepsi->deskripsi}})</strong></h5>
            </div>
        </div>
    </div>
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                <div class="card-header" style="background: #FF7F50;">Jawaban Miskonsepsi {{$miskonsepsi->jenis}} </div>
                <div class="card-body">
