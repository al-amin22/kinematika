    ...
    <div class="row">
        <div class="col-md-12">
            <div class="alert alert-success" role="alert">
                <h5 class="alert-heading mb-0" style="background: #FF7F50;"><strong>{{$peserta_ujian->ujian->kelas->nama_kelas}} </strong></h5>
            </div>
        </div>
    </div>
    <div class="row">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header" style="background: #FF7F50;">Detail Hasil Test {{$peserta_ujian->siswa->nama_lengkap}}</div>
                <div class="card-body">
