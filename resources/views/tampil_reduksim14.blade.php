...
<main class="main">
                  <p>
                    <a href="{{route('createm14')}}"><button type="button" class="btn btn-primary">Tambah Reduksi</button></a>
                  </p>

     			@foreach($tampilReduksim14 as $item)
                ...
                <div class="app-main__inner">
                  ...
                  <p>
                    <a href="{{route('editm14', $item->id)}}"><button type="button" class="btn btn-primary">Edit Reduksi</button></a>
                  </p>
