...
<main class="main">
    <div class="container-fluid">
        ...
        <div class="alert alert-success" role="alert" style="background: linear-gradient(180deg, #FF7F50 0%, #DEB887 100%); box-shadow: 10px 0px 10px rgba(0, 0, 0, 0.25) ">
        ...
        <div class="row">
            <div class="col-md-4">
                <div class="card ">
                    <div class="card-header" style="background: #FF7F50;">Daftar Siswa</div>
                    <div class="card-body">
                        @if($anggotakelas->count() != 0)
                        <table class="table table-striped table-sm">
                            <thead class="thead-dark thead text-center" style="background-color:#FF7F50; color:white; font-weight:bold">
                                <tr>
                                    <td width="40px">No</td>
                                    <td>Nama Siswa</td>
                                    <td width="30px"></td>
