...
<form action="{{route('tambahReduksifalsePositive')}}" method="post">
  @csrf
  
  <div class="form-group">
    <label for="exampleFormControlInput1">Model Pembelajaran</label>
    <input type="textarea" class="form-control" id="exampleFormControlInput1" placeholder="model Pembelajaran" name="model_reduksifalsePositive">
  </div>
