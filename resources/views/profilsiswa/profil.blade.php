...
@if ( Siswa::where('user_id', Auth::user()->id )->first() != null )
    <div class="row">
        ...
        <div class="col-md-8">
            <div class="card mb-3" >
                ...
                <div class="card-footer justify-content-center" style="border-radius: 0px 0px 20px 20px ">
                    <a href="{{route('editProfilSiswa')}}"><button class="btn btn-warning"  style="box-shadow: 3px 2px 5px grey;"> Edit Profil </button></a>
                </div>
        ...
        <div class="col-md-4">
            <div class="card" >
                <div class="card-header pt-3 pb-2 justify-content-center" style="background: #FF7F50;">
