...
<form action="{{route('updatefalseNegative', $editreduksifalseNegative->id)}}"  method="post">
  @csrf
  @method('PATCH')
  ...
  <div class="form-group">
    ...
    value="{{$editreduksifalseNegative->model_reduksifalseNegative}}" name="model_reduksifalseNegative">
  </div>
