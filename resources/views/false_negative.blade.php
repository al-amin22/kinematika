        ...
        <div class="app-main">
            ...
            @include('layouts.siswa.sidebar')
                <div class="app-main__inner">
                    ...
                    <h1>Anda Mengalami False Negative</h1>
                    </div>
                    ...
                    <div>
                     <div><a href=""><button class="btn btn-warning" style="box-shadow: 3px 2px 5px grey;"><i class="fa fa-reply mr-1"></i>Kembali</button></a>
                    </div>
                </div>
