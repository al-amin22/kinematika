                    ...
                    if ($jawaban_tk4_kode == 1) {
                        foreach ($semua_soal_satuan as  $item) {
                            if ($semua_soal_satuan[0]['id'] == $request->soal_satuan_id) {
                                if ($jawaban_tk1->jawaban == 'A' && $jawaban_tk2->jawaban == 'A' && $jawaban_tk3->jawaban == 'A' && $jawaban_tk4->jawaban == 'A') {
                                    $miskonsepsi_id = 1;
                                    //M1
                            ...
                            }elseif ($semua_soal_satuan[7]['id'] == $request->soal_satuan_id) {
                                if ($jawaban_tk1->jawaban == 'A' && $jawaban_tk2->jawaban == 'A' && $jawaban_tk3->jawaban == 'A' && $jawaban_tk4->jawaban == 'A') {
                                    $miskonsepsi_id = 16;
                                    //M16
                                }elseif ($jawaban_tk1->jawaban == 'B' && $jawaban_tk2->jawaban == 'A' && $jawaban_tk3->jawaban == 'B' && $jawaban_tk4->jawaban == 'A') {
                            ...
                            }elseif ($semua_soal_satuan[8]['id'] == $request->soal_satuan_id) {
                                if ($jawaban_tk1->jawaban == 'A' && $jawaban_tk2->jawaban == 'A' && $jawaban_tk3->jawaban == 'A' && $jawaban_tk4->jawaban == 'A') {
                                    $miskonsepsi_id = 19;
                                    //M19
                                }elseif ($jawaban_tk1->jawaban == 'C' && $jawaban_tk2->jawaban == 'A' && $jawaban_tk3->jawaban == 'C' && $jawaban_tk4->jawaban == 'A') {
